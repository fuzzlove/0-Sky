...
#define TS_LITE_MARKER @"_CrypStore"
#define TS_NAME @"Commissary"
#define TS_LITE_NAME TS_CONTROL_PRODUCT_NAME

#ifdef TROLLSTORE_LITE
#define TS_ACTIVE_MARKER TS_LITE_MARKER
#define TS_INACTIVE_MARKER TS_MARKER
#define APP_ID @"com.liquidsky.CrypStore"
...
extern int setDeviceAccountPassword(NSString* account, NSString* password, NSString** stdErr);

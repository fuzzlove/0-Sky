...
SKIP_DIRS = {".git", ".build", "build", "dist", ".theos", "DerivedData",
...
CHECKS = (
    ...
    ("local-account", re.compile(rb"(?<![A-Za-z0-9])joem(?![A-Za-z0-9])", re.I)),
    ("personal-name", re.compile(rb"\bJoseph(?:\s+|-)McPeters\b", re.I)),
